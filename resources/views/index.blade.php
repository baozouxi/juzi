    ...
    @foreach($passages as $passage)
        <div class="article_item">
            <div class="item_wrap">
                ...
                <div class="content cpy_div_{{ $passage->id }}">{{ $passage->content }}
                </div>
                ...
                <div class="article_btn tr">
                    ...
                    <span class="copy_btn"  data-clipboard-action="copy" data-clipboard-target="cpy_div_{{ $passage->id }}"><i class="iconfont">&#xe6ea;</i>复制</span>
